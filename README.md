...
- **Accessible UI:** Utilizes **Shadcn UI** and Radix primitives to ensure components are fully accessible and keyboard-navigable.
- **Serverless API Integration:** Features a robust contact dialog powered by Next.js API Routes.
- **Performance Optimized:** Achieves near-perfect Core Web Vitals through aggressive image optimization, lazy loading, and modern web font handling.
...
│   ├── data/               # Local JSON data (projects, experience)
...
- **LinkedIn:** [Afolabi Ridwan Damilare](https://linkedin.com/in/codewithmercy1)
