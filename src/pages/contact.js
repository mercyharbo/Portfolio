    ...
    >
      <section className='flex flex-col justify-start items-start gap-8'>
        ...
        <p className='lg:text-xl md:text-lg sm:text-base'>
          ...
          about me, feel free to contact me anytime. I&#8217;d love to hear from
          you. You can reach me by email at email or mobile number. You can also
          follow me on my social media account . Thank you for visiting my
          portfolio website.
        </p>
