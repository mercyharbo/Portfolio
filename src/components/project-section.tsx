  ...
  return (
    <section id='works' className='section flex flex-col gap-8 w-full'>
      <div className='flex flex-col gap-5'>
        ...
        <p ref={addToRefs} className='section-content max-w-2xl'>
      ...
      <div className='section-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full'>
        {projectJSON.map((item) => (
          <div
            ...
            border border-gray dark:border-gray/30 dark:hover:border-gray rounded-lg hover:border-gray hover:shadow-lg h-full cursor-pointer'
          >
